...
public partial class Shelter : Node3D
{
    ...
    {
        Fitting.Armoury => (Strings.Get("fitting.armoury.title"),
                            Strings.Get("fitting.armoury.first"),
                            Strings.Get("fitting.armoury.second")),
        Fitting.Locker => (Strings.Get("fitting.locker.title"),
                           Strings.Get("fitting.locker.first"), ""),
        Fitting.Records => (Strings.Get("fitting.records.title"), "", ""),
        Fitting.Board => (Strings.Get("fitting.board.title"),
                          Strings.Get("fitting.board.first"),
                          Strings.Get("fitting.board.second")),
        Fitting.Map => (Strings.Get("fitting.map.title"),
                        Strings.Get("fitting.map.first"),
                        Strings.Get("fitting.map.second")),
        Fitting.Gate => (Strings.Get("fitting.gate.title"),
                         Strings.Get("fitting.gate.first"), ""),
